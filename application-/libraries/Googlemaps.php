...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyDl1fNnC-kRcfPSi1eaw95L8Csm_0329Xs'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function create_map()
	{
		$this->output_js = '<script src="https://maps.googleapis.com/maps/api/js?key='.$this->apiKey.'&callback=initMap"  async defer></script>';
