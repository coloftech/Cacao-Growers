<!-- Start Blog Area -->
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog">
              <div class="single-blog-img">
                <a href="<?=site_url('home/updates')?>">
                    <img src="<?=base_url()?>public/images/cacao-training.jpg" alt="">
                  </a>
              </div>
              <div class="blog-meta">
              ...
              <div class="blog-text">
                <h4>
                                        <a href="<?=base_url()?>themes/eBusiness/<?=site_url('home/updates')?>">Assumenda repud eum veniam</a>
                  </h4>
                <p>
              ...
              <span>
                  <a href="<?=site_url('home/updates')?>" class="ready-btn">Read more</a>
                </span>
            </div>
            <!-- Start single blog -->
          </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog">
              <div class="single-blog-img">
                <a href="<?=site_url('home/updates')?>">
                    <img src="<?=base_url()?>public/images/2.jpg" alt="">
                  </a>
              </div>
              <div class="blog-meta">
                <span class="comments-type">
              ...
              <div class="blog-text">
                <h4>
                                        <a href="<?=site_url('home/updates')?>">Explicabo magnam quibusdam.</a>
                  </h4>
                <p>
                  Lorem ipsum dolor sit amet conse adipis elit Assumenda repud eum veniam optio modi sit explicabo nisi magnam quibusdam.sit amet conse adipis elit Assumenda repud eum veniam optio modi sit explicabo nisi magnam quibusdam.
                </p>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="single-blog">
              ...
              <div class="blog-text">
                <h4>
                                        <a href="<?=base_url()?>themes/eBusiness/<?=site_url('home/updates')?>">Lorem ipsum dolor sit amet</a>
                  </h4>
                <p>
                  Lorem ipsum dolor sit amet conse adipis elit Assumenda repud eum veniam optio modi sit explicabo nisi magnam quibusdam.sit amet conse adipis elit Assumenda repud eum veniam optio modi sit explicabo nisi magnam quibusdam.
                </p>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="well-left">
            <div class="single-well">
              <a href="#">
								  <img src="<?=base_url()?>public/images/tablea.jpg" alt="">
								</a>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="wellcome-text">
              <div class="well-text text-center">
                <h2>Welcome To Our <span>Bohol</span> Cacao</h2>
                <p>
  ...
  <!-- Start team Area -->
  <div id="team" class="our-team-area area-padding hidden">
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="section-headline text-center">
        ...
        <div class="team-top">
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="<?=base_url()?>themes/eBusiness/img/team/1.jpg" alt="">
									</a>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="<?=base_url()?>themes/eBusiness/img/team/2.jpg" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="<?=base_url()?>themes/eBusiness/img/team/3.jpg" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
										<img src="<?=base_url()?>themes/eBusiness/img/team/4.jpg" alt="">
									</a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
  ...
  <!-- Start reviews Area -->
  <div class="reviews-area hidden-xs hidden">
    <div class="work-us">
      <div class="work-left-text">
        <a href="#">
						<img src="<?=base_url()?>themes/eBusiness/img/about/2.jpg" alt="">
					</a>
      </div>
      ...
      <div class="row">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="awesome-menu ">
              <ul class="project-menu">
                ...
                <li>
                  <a href="#" data-filter=".development">Farm</a>
                </li>
                <li>
                  <a href="#" data-filter=".design">Traders</a>
                </li>
                <li>
                  <a href="#" data-filter=".photo">Training</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="awesome-project-content">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design development">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="<?=base_url()?>public/images/1.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?=base_url()?>public/images/1.jpg">
                      <h4>Business City</h4>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 photo">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="<?=base_url()?>public/images/2.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?=base_url()?>public/images/2.jpg">
                      <h4>Blue Sea</h4>
                      <span>Photosho</span>
                    </a>
                  </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 design">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="<?=base_url()?>public/images/3.jpg" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?=base_url()?>public/images/3.jpg">
            ...
            <div class="single-awesome-project">
              <div class="awesome-img">
                ...
                <div class="add-actions text-center text-center">
                  <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="<?=base_url()?>public/images/4.jpg">
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs=12">
          <div class="suscribe-text text-center">
            <h3>Welcome to our <span>Bohol</span> Cacao company</h3>
    ...
    <div class="contact-inner area-padding">
      ...
      <div class="container ">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <!-- Start Map -/->
            <iframe src="https://www.google.com/maps/d/embed?mid=17iFTA0ZbaiFPhx-mOifKURqR4dk" width="100%" height="380" frameborder="0" style="border:0" allowfullscreen></iframe>
            -->
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1006178.5514274818!2d123.60298033998527!3d9.90185998774785!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33aa17de1ba154df%3A0x6bc8bf042118d020!2sBohol!5e0!3m2!1sen!2sph!4v1548914687025"  width="100%" height="360" frameborder="0" style="border:0" allowfullscreen></iframe>
            <!-- End Map
https://maps.googleapis.com/maps/api/js?key=AIzaSyANgYPIG2zjfeGLi4V_ii7prB7ygmJTieE&callback=initMap
             -->
          </div>
          <!-- End Google Map -->
