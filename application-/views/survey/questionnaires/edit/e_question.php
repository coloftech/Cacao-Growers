                      ...
                      <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true"></div>
                        ...
                        <div class="tab-content">
                          <div id="home" class="tab-pane fade in active">
                            ...
                            <p><?php include_once 'e_respondent_info2.php'; ?></p>
                          </div>
                          <div id="menu1" class="tab-pane fade">
                            <h3>FARM PROFILE</h3>
                            <p><?php include_once 'e_respondent_farmprofile2.php'; ?></p>
                          </div>

                          <div id="menu2" class="tab-pane fade">
                            <h3>PEST &amp; DISEASES</h3>
                            <p><?php include_once 'e_respondent_pest2.php'; ?></p>
                          </div>
                          <div id="menu3" class="tab-pane fade">
                            <h3>PRODUCTION MANAGEMENT</h3>
                            <p><?php include_once 'e_respondent_production2.php'; ?></p>
                          </div>
                          <div id="menu4" class="tab-pane fade">
                            <h3>POST HARVEST</h3>
                            <p><?php include_once 'e_respondent_harvest2.php'; ?></p>
                          </div>
                          <div id="menu5" class="tab-pane fade">
                            <h3>MARKETING</h3>
                            <p><?php include_once 'e_respondent_marketing2.php'; ?></p>
