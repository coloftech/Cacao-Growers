            ...
            <form id="frm_farmprofile" class="form">   
              ...
              <div class="form-group width-full">
                ...
                <input type="text" class="form-control" name="planting_distance" placeholder="2x2">
                    </div>
                </div>
              </div>
              ...
              <div class="form-group width-full">
                ...
                <div class="choices">
                  ...
                  <div class="col-md-12 others-input">
                      <small>Others, specify here</small><input type="text" class="form-control" name="othersCacaoClones">
                  </div>
                </div>
              ...
              <div class="form-group width-full">
                ...
                <input type="text" class="form-control" name="Sourceofseeds" placeholder="DA">
                    </div>
                </div>
              </div>
              <div class="form-group width-full">
                ...
                <input type="text" class="form-control" name="Sourceofscions" placeholder="DA">
                    </div>
                </div>
              </div>
              <div class="form-group width-full">
                ...
                <input type="text" class="form-control" name="Sourceofstocks" placeholder="DA">
                    </div>
                </div>
              </div>
              <div class="form-group width-full">
                ...
                <input type="text" class="form-control" name="Sourceofseedlings" placeholder="DA">
                    </div>
                </div>
              </div>
              ...
              <div class="form-group width-full">
                ...
                <div class="choices">
                  ...
                  <div class="col-md-12">
                      <small>If yes, how many square meters?</small><input type="text" class="form-control" name="othersnursery">
                  </div>
                </div>
              ...
              <div class="form-group width-full">
                ...
                <div class="choices">
                  ...
                  <div class="col-md-12">
                      <small>If yes, How much per seedling?</small><input type="text" class="form-control" name="otherssellSeedlings">
                  </div>
                </div>
