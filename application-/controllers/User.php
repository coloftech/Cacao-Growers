...
class User extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->global['new_added_survey'] = count($this->survey->getbydate(date('Y-m-d')));
        ...
        $this->load->model('visitors_model','visits');
            ...
            foreach ($visits as $key) {
                # code...
                $totalvisits += $key->counter;
            }
        $this->global['totalvisits'] = $totalvisits;
        $this->global['visits'] = $visits;
