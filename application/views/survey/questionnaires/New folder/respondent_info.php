            <form class="form" id="frmPersonalInfo">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <div class="col-md-4 xradio">
                                  <div class="xradio-success">
                                    
                                   <input type="radio" name="civilstatus" id="single" value="Single" checked="true"><label for="single">Single</label>
                              ...
                              <div class="col-md-4 xradio">
                                  <div class="xradio-success">
                                   ...
                                   <input type="radio" name="civilstatus" id="Married" value="Married"><label for="Married">Married</label>
                              ...
                              <div class="col-md-4 xradio">
                                  <div class="xradio-success">
                                   ...
                                   <input type="radio" name="civilstatus" id="widow" value="Widow/Widower"><label for="widow">Widow/Widower</label>
