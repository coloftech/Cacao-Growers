...
<div class="form-group">
                            ...
                            <div class="form-group">
                              <label>Cropping System:</label>
                               <div class="radio">
                              <label for="cropingsystem_1" class="btn btn-sm"><input type="checkbox" name="cropingsystem[]"  id="cropingsystem_1" checked="">Monocropping</label>
                            ...
                            <div class="form-group">
                              ...
                              <div class="radio">
                              <label for="AssociatedCrops_0" class="btn btn-sm"><input type="checkbox" name="AssociatedCrops[]" id="AssociatedCrops_0" value="0">Coconut</label>
