  ...
  <section id="main-slider" class="no-margin">
    <div class="carousel slide">
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(public/images/cacao.jpg)">
          <div class="container">
            <div class="row slide-margin">
              ...
              <div class="col-sm-6 hidden-xs animation animated-item-4">
                <div class="slider-img">
                  ...
                  <img src="<?=base_url('assets/themes')?>/Company/images/slider/img3.png" class="img-responsive">
                </div>
              </div>
      ...
      <div class="text-center">
        <div class="col-md-4">
          <div class="hi-icon-wrap hi-icon-effect wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
            <img src="<?=base_url('public/images/c-cacao.png')?>">
            <i class="fa fa-book hidden"></i>
            <h2>Criollo</h2>
        ...
        <div class="col-md-4">
          <div class="hi-icon-wrap hi-icon-effect wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
            <img src="<?=base_url('public/images/f-cacao.png')?>">
            <i class="fa fa-laptop hidden"></i>
            <h2>Forastero</h2>
        ...
        <div class="col-md-4">
          <div class="hi-icon-wrap hi-icon-effect wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="900ms">
            <img src="<?=base_url('public/images/t-cacao.png')?>">
  ...
  <section id="partner">
    <div class="container">
      ...
      <div class="partners">
        <ul>
          <li> <a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms" src="<?=base_url('assets/themes')?>/Company/images/partners/partner1.png"></a></li>
          <li> <a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms" src="<?=base_url('assets/themes')?>/Company/images/partners/partner2.png"></a></li>
          <li> <a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="900ms" src="<?=base_url('assets/themes')?>/Company/images/partners/partner3.png"></a></li>
          <li> <a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="1200ms" src="<?=base_url('assets/themes')?>/Company/images/partners/partner4.png"></a></li>
          <li> <a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="1500ms" src="<?=base_url('assets/themes')?>/Company/images/partners/partner5.png"></a></li>
        </ul>
      </div>
    </div>
    <!--/.container-->
